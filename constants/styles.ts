...
export const CSS_CLASSES = {
    ...
    // Mobile menu styles
    mobileOverlay: "lg:hidden fixed inset-0 z-[999] transition-opacity duration-300 ease-in-out",
    ...
    mobileHeader: "flex items-center justify-between p-4 border-b bg-[#f8f8ff]",
    mobileNavItem: "block px-6 py-4 text-lg font-medium text-gray-700 hover:text-blue-700 hover:bg-gray-50 transition-colors border-b border-gray-100",
    mobileSubItem: "block px-12 py-3 text-base text-gray-600 hover:text-blue-700 hover:bg-white transition-colors",
    ...
    // Header styles
    header: "sticky top-0 z-50 bg-[#f8f8ff]/80 backdrop-blur transition-all duration-500 ease-out",
