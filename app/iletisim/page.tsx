                        ...
                        <div className={`space-y-8 transition-all duration-600 ${isHighlighted ? 'blur-sm opacity-60' : 'blur-0 opacity-100'}`}>
                            ...
                            <div className="bg-white rounded-lg shadow-lg p-8">
                                ...
                                <div className="space-y-4">
                                    <a href="#" className="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">@2bglobalenerji</p>
                                        </div>
                                    </a>
                                    ...
                                    <a href="#" className="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">+90 242 324 60 77</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
