                            ...
                            <div className={`space-y-8 transition-all duration-600 ${isScrolling || isHighlighted ? 'blur-sm opacity-60' : 'blur-0 opacity-100'}`}>
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-start space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600">info@2bltd.com.tr</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600">0242 324 60 77</p>
                                            </div>
                                        </div>
                                ...
                                <div className="bg-white rounded-lg shadow-lg p-8">
                                    ...
                                    <div className="space-y-4">
                                        <a href="https://www.instagram.com/2b_global_enerji?igsh=MTNyeDhuMjVlNGphMg==" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                                            <div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-600 rounded-lg flex items-center justify-center text-white group-hover:scale-105 transition-transform">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">@2b_global_enerji</p>
                                            </div>
                                        </a>

                                        <a href="#" className="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                                            <div className="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center text-white group-hover:scale-105 transition-transform">
                                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">2B Global Enerji</p>
                                            </div>
                                        </a>

                                        <a href="https://wa.me/905454036676" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                                            <div className="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center text-white group-hover:scale-105 transition-transform">
                                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">Sohbete başla</p>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-3 px-6 rounded-lg transition-colors font-medium ${isSubmitting
                                    ...
                                    {/* Teşekkür Mesajı */}
                                    <div className="mt-6 py-6 px-6">
                                        <p className="text-lg font-semibold text-gray-800 text-center leading-relaxed relative">
                                            <span className="relative z-10">
                                                Fikirleriniz ve geri dönüşleriniz bizler için çok kıymetli.
                                                Bizimle iletişime geçtiğiniz için teşekkür ederiz.
                                            </span>
                                            <span className="absolute top-1 left-1 text-lg font-semibold text-black opacity-30 blur-sm z-0">
                                                Fikirleriniz ve geri dönüşleriniz bizler için çok kıymetli.
                                                Bizimle iletişime geçtiğiniz için teşekkür ederiz.
                                            </span>
                                        </p>
